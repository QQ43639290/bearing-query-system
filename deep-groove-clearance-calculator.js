...
function createDeepGrooveClearanceModal() {
    ...
    // 模态框内容
    modal.innerHTML = `
        <div class="price-ref-content deep-groove-modal" style="
            background: #f4f6f9;
            margin: 10px auto;
            padding: 20px;
            border-radius: 6px;
            ...
            overflow-y: auto;
        ">
            <div style="position: relative; background: linear-gradient(135deg, #00a8ff, #0066cc); color: white; padding: 0 20px; margin-bottom: 20px;">
            ...
            <div class="price-ref-panel active">
                <div class="card" style="margin-bottom: 18px;">
                    <div class="card-header">输入条件</div>
                    <div class="card-body">
                        <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                            ...
                            <thead>
                                <tr>
                                    <th style="background: #f0f4fb; color: #1a3a6b; font-weight: 600; white-space: nowrap; text-align: center; border: 1px solid #dde3ed; padding: 5px; font-size: 13px; width: 80px;">轴承型号</th>
                                    <th style="border: 1px solid #dde3ed; padding: 5px; text-align: left;"><input type="text" id="dg_bearingModel" value="6004" style="width:100%; font-size: 13px;"></th>
                                    <th style="background: #f0f4fb; color: #1a3a6b; font-weight: 600; white-space: nowrap; text-align: center; border: 1px solid #dde3ed; padding: 5px; font-size: 13px;">精度等级</th>
                        ...
                        <table style="margin-top:12px; border-collapse: collapse; width: 100%;">
                            ...
                            <thead>
                                <tr>
                                    <th style="background: #f0f4fb; color: #1a3a6b; font-weight: 600; white-space: nowrap; text-align: center; border: 1px solid #dde3ed; padding: 5px; font-size: 13px;">分类</th>
                                    <th style="background: #f0f4fb; color: #1a3a6b; font-weight: 600; white-space: nowrap; text-align: center; border: 1px solid #dde3ed; padding: 5px; font-size: 13px;">项目/mm</th>
                                    <th style="background: #f0f4fb; color: #1a3a6b; font-weight: 600; white-space: nowrap; text-align: center; border: 1px solid #dde3ed; padding: 5px; font-size: 13px;">基本尺寸</th>
                                    <th style="background: #f0f4fb; color: #1a3a6b; font-weight: 600; white-space: nowrap; text-align: center; border: 1px solid #dde3ed; padding: 5px; font-size: 13px;">公差 MIN</th>
                                    <th style="background: #f0f4fb; color: #1a3a6b; font-weight: 600; white-space: nowrap; text-align: center; border: 1px solid #dde3ed; padding: 5px; font-size: 13px;">公差 MAX</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                ...
                <div class="card" style="margin-bottom: 18px;">
                    <div class="card-header" style="display: flex; align-items: center; background: #edf1f8; border-bottom: 1px solid #dde3ed; padding: 9px 16px; font-weight: 600; font-size: 13px; color: #1a3a6b;">
                        <span style="flex: 1;">材料属性</span>
                        <button class="btn-secondary" style="font-size:11px;padding:3px 10px; background: #edf1f8; color: #1a3a6b; border: 1px solid #c5d3e8; white-space: nowrap; width: auto;" onclick="showDeepGrooveMaterialTable()">查看材料属性表</button>
                    </div>
                    <div class="card-body">
                        <table style="width:100%; border-collapse: collapse; font-size: 13px;">
                            <colgroup>
                ...
                <div class="card" id="dg_result-card" style="display:none;">
    ...
    style.textContent = `
        ...
        .deep-groove-modal .card-header::before {
            content: "";
        ...
        .deep-groove-modal .card-body {
            padding: 16px;
        }
        .deep-groove-modal .card-body table {
            width: 100%;
            border-collapse: collapse;
        }
        .deep-groove-modal .card-body th, .deep-groove-modal .card-body td {
            border: 1px solid #dde3ed;
            padding: 6px 10px;
            text-align: left;
            vertical-align: middle;
        }
        .deep-groove-modal .card-body th {
            background: #f0f4fb;
            color: #1a3a6b;
            font-weight: 600;
            white-space: nowrap;
        ...
        .deep-groove-modal .card-body table td.label {
            background: #f8f9fc !important;
            color: #555 !important;
            white-space: nowrap !important;
        }
        .deep-groove-modal .card-body table th {
        ...
        .deep-groove-modal .card-body table td.group {
        ...
        .deep-groove-modal .card-body td.calc {
            background: #f0f7ff;
            color: #1565c0;
            text-align: right;
            font-family: monospace;
        }
        .deep-groove-modal .card-body td.result-min {
            color: #c62828;
            text-align: center;
            font-family: monospace;
            font-weight: 600;
        }
        .deep-groove-modal .card-body td.result-mean {
            color: #2e7d32;
            text-align: center;
            font-family: monospace;
            font-weight: 600;
        }
        .deep-groove-modal .card-body td.result-max {
            color: #1565c0;
            text-align: center;
            font-family: monospace;
            font-weight: 600;
        }
        .deep-groove-modal .card-body td.center {
            text-align: center;
        }
        .deep-groove-modal .card-body td.val {
            text-align: right;
            font-family: monospace;
            color: #555;
        }
        .deep-groove-modal .card-body input[type="number"],
        .deep-groove-modal .card-body input[type="text"],
        .deep-groove-modal .card-body select {
            width: 100%;
            padding: 4px 7px;
        ...
        .deep-groove-modal .card-body input[type="number"]:focus,
        .deep-groove-modal .card-body input[type="text"]:focus,
        .deep-groove-modal .card-body select:focus {
            border-color: #1a3a6b;
        }
        .deep-groove-modal .btn-row {
            display: flex;
            gap: 10px;
            justify-content: flex-end;
            margin-bottom: 14px;
        }
        .deep-groove-modal button {
            padding: 8px 22px;
            border: none;
            border-radius: 4px;
            font-size: 13px;
        ...
        .deep-groove-modal .btn-primary {
            background: #1a3a6b;
            color: #fff;
        }
        .deep-groove-modal .btn-primary:hover {
            background: #163260;
        }
        .deep-groove-modal .btn-secondary {
            background: #edf1f8;
            color: #1a3a6b;
            border: 1px solid #c5d3e8;
        }
        .deep-groove-modal .btn-secondary:hover {
            background: #dde3ed;
        }
        .deep-groove-modal .process-table td {
            font-size: 12px;
        }
    `;
