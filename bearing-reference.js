...
function createBearingRefModal() {
  ...
  style.textContent = `
    ...
    .bearing-ref-content { background: var(--card-bg); border-radius: 8px; width: 99%; max-width: 1400px; max-height: 90vh; overflow: hidden; display: flex; flex-direction: column; box-shadow: 0 4px 20px rgba(0,0,0,0.2); }
